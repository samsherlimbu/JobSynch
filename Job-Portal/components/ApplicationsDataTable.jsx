...
//add link => change appp : {link: input-> link}
    ...
    const columns = [
        ...
        // {
        //     name: 'create meeting',
        //     selector: row => row?.status === 'approved' ? <p onClick={()=>{
        //         window.open('https://meet.new/', '_blank');
        //     }}>Create a meeting</p> : <p> Not Approved  </p>
        // },
        
        {
            name: 'Action',
            cell: row => (
                <div className='flex items-center justify-start w-72 h-20' onClick = {()=> setResponse(true) }>
