...
export default function PostAJob() {
    ...
    const [formData, setFormData] = useState({ user: user?._id, title: "", salary: 0, email: "", company: "",location: "", company_url:"", description: "", job_category: "", job_type: "", job_experience: "", job_vacancy: 0, job_deadline: "" });

    const [error, setError] = useState({ user: "", title: "", salary: "", email: "", company: "", location:"", company_logo: "", description: "", job_category: "", job_type: "", job_experience: "", job_vacancy: "", job_deadline: "" });
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.company_logo) {
            setError({ ...error, company_logo : "comapny logo Field is required" })
            return;
        }
        ...
        <>
            ...
            <div className='w-full  py-20 flex items-center  justify-center flex-col'>
                ...
                <form onSubmit={handleSubmit} className="sm:w-1/2 w-full px-4 mx-4  h-full" >
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        <label htmlFor="company_logo" className='mb-1 text-base font-semibold'>Company Logo :</label>
                        <input onChange={(e) => setFormData({ ...formData, company_logo: e.target.value })} type="text" id='company' className='w-full py-2 px-3 mb-2 border border-indigo-600 rounded' placeholder='Enter Company of job' />
                        {
                            error.company_logo && <p className="text-sm text-red-500">{error.company_logo}</p>
                        }
                    </div>
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
